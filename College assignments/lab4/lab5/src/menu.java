    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (op) {
                ...
                case 2: // Por questao de tempo nao implementei o menu de cadastro pois seria bastante
                        // trabalhoso, entao alteracoes sao feitas no proprio codigo
                        // O jeito mais bonito seria fazer um metodo addEventListener e
                        // removeEventListener e fazer com que ele adicionasse de forma dinamica na
                        // lista no menu de criacao
                ...
                case 3:
                    ...
                    pt.removerObservador(a);
                    pt.removerObservador(ag);
                    break;
